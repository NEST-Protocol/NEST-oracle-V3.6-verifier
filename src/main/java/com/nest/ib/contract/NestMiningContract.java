...
public class NestMiningContract extends Contract {
    ...
    public RemoteFunctionCall<List> list(String tokenAddress, BigInteger offset, BigInteger count, BigInteger order) {
        final Function function = new Function("list",
                Arrays.<Type>asList(new Address(tokenAddress), new Uint(offset), new Uint(count), new Uint(order)),

...
public class VerifierController {
     ...
     * @return
     */
    @PostMapping("/updateBiteTokenState")
    public R updateBiteTokenState() {
        verifyState.setBiteToken(!verifyState.isBiteToken());
        return R.ok();
    }

    /**
     * Enable/disable ntoken validation
     */
    @PostMapping("/updateBiteNtokenState")
    public R updateBiteNtokenState() {
        verifyState.setBiteNtoken(!verifyState.isBiteNtoken());
        return R.ok();
    }
    ...
    /**
     * NToken threshold configuration
     */
    @PostMapping("/updateNtokenBiteInfo")
    public R updateNtokenBiteInfo(@RequestParam(name = "biteRate") BigDecimal biteRate) {
        verifyState.setnTokenBiteThreshold(biteRate);
        return R.ok();
    }
